...
func _ready() -> void:
	...
	var buttons = [
		...
		$Panel_Container/Main_Menu/VBoxContainer/LoadGameButton,
...
# Start Button → Save Slot Menu
func _on_start_button_pressed() -> void:
	Music_Controller.play_start_button()
	get_tree().change_scene_to_file("res://Scenes/Save_Slot_Menu.tscn")

# Load Game button → Save Slot Menu
